...

{
  ...
  *aStatus = nsIGfxInfo::FEATURE_STATUS_UNKNOWN;
  ...
  if (mGLMajorVersion == 1) {
    ...
    // see bug 696636
    if (aFailureId) {
      *aFailureId = strdup("FEATURE_FAILURE_OPENGL_1");
    }
    ...
    if (aFeature == nsIGfxInfo::FEATURE_OPENGL_LAYERS ||
      ...
      if (aFeature == nsIGfxInfo::FEATURE_OPENGL_LAYERS && !mHasTextureFromPixmap) {
        *aStatus = nsIGfxInfo::FEATURE_BLOCKED_DRIVER_VERSION;
        if (aFailureId) {
          *aFailureId = strdup("FEATURE_FAILURE_NO_PIXMAP");
        }
      ...
      if (mIsMesa) {
        if (mIsNouveau && version(mMajorVersion, mMinorVersion) < version(8,0)) {
          *aStatus = nsIGfxInfo::FEATURE_BLOCKED_DRIVER_VERSION;
          if (aFailureId) {
            *aFailureId = strdup("FEATURE_FAILURE_MESA_1");
          }
          ...
          *aStatus = nsIGfxInfo::FEATURE_BLOCKED_DRIVER_VERSION;
          if (aFailureId) {
            *aFailureId = strdup("FEATURE_FAILURE_MESA_2");
          }
          ...
          *aStatus = nsIGfxInfo::FEATURE_BLOCKED_DRIVER_VERSION;
          if (aFailureId) {
            *aFailureId = strdup("FEATURE_FAILURE_SW_RAST");
          }
        }
          ...
          *aStatus = nsIGfxInfo::FEATURE_BLOCKED_DRIVER_VERSION;
          if (aFailureId) {
            *aFailureId = strdup("FEATURE_FAILURE_MESA_3");
          }
        }
        else if (aFeature == nsIGfxInfo::FEATURE_WEBGL_MSAA)
        {
          if (mIsIntel && version(mMajorVersion, mMinorVersion) < version(8,1)) {
            *aStatus = nsIGfxInfo::FEATURE_BLOCKED_DRIVER_VERSION;
            if (aFailureId) {
              *aFailureId = strdup("FEATURE_FAILURE_MESA_4");
            }
        ...
        if (version(mMajorVersion, mMinorVersion, mRevisionVersion) < version(257,21)) {
          *aStatus = nsIGfxInfo::FEATURE_BLOCKED_DRIVER_VERSION;
          if (aFailureId) {
            *aFailureId = strdup("FEATURE_FAILURE_OLD_NV");
          }
        ...
        if (version(mMajorVersion, mMinorVersion, mRevisionVersion) < version(3, 0)) {
          *aStatus = nsIGfxInfo::FEATURE_BLOCKED_DRIVER_VERSION;
          if (aFailureId) {
            *aFailureId = strdup("FEATURE_FAILURE_OLD_FGLRX");
          }
        ...
        if (unknownOS || badOS) {
          if (aFailureId) {
            *aFailureId = strdup("FEATURE_FAILURE_OLD_OS");
          }
